...
const en: Translations = {
  ...
  shareReviewMsg: 'Daily share reward is now manual. Contact @polnationsupport to claim your bonus spin.',
...
const zh: Translations = {
  ...
  shareReviewMsg: '每日分享奖励改为人工审核,请联系 @polnationsupport 申请你的奖励抽奖次数。',
  firstWinTitle: '🎉 新人见面礼！',
...
const ru: Translations = {
  ...
  shareReviewMsg: 'Ежедневная награда за репост теперь выдаётся вручную. Напишите @polnationsupport, чтобы получить бонусный спин.',
...
const es: Translations = {
  ...
  shareReviewMsg: 'La recompensa diaria por compartir ahora es manual. Contacta a @polnationsupport para reclamar tu giro extra.',
...
const pt: Translations = {
  ...
  shareReviewMsg: 'A recompensa diária por compartilhar agora é manual. Fale com @polnationsupport para resgatar seu giro bônus.',
...
const fr: Translations = {
  ...
  shareReviewMsg: 'La récompense de partage quotidienne est désormais manuelle. Contactez @polnationsupport pour réclamer votre tour bonus.',
...
const ja: Translations = {
  ...
  shareReviewMsg: '毎日のシェア報酬は手動審査になりました。ボーナススピンは @polnationsupport までご連絡ください。',
...
const ko: Translations = {
  ...
  shareReviewMsg: '일일 공유 보상은 이제 수동 처리됩니다. 보너스 스핀은 @polnationsupport에 문의하세요.',
  firstWinTitle: '🎉 웰컴 선물!',
...
const tr: Translations = {
  ...
  shareReviewMsg: 'Günlük paylaşım ödülü artık manuel. Bonus hakkını almak için @polnationsupport ile iletişime geç.',
...
const id: Translations = {
  ...
  shareReviewMsg: 'Hadiah berbagi harian kini manual. Hubungi @polnationsupport untuk klaim putaran bonusmu.',
...
const vi: Translations = {
  ...
  shareReviewMsg: 'Phần thưởng chia sẻ hằng ngày nay được duyệt thủ công. Liên hệ @polnationsupport để nhận lượt quay thưởng.',
...
const hi: Translations = {
  ...
  shareReviewMsg: 'डेली शेयर इनाम अब मैन्युअल है। बोनस स्पिन के लिए @polnationsupport से संपर्क करें।',
...
const ar: Translations = {
  ...
  shareReviewMsg: 'مكافأة المشاركة اليومية أصبحت يدوية الآن. تواصل مع @polnationsupport للحصول على لفتك الإضافية.',
...
const ur: Translations = {
  ...
  shareReviewMsg: 'روزانہ شیئر انعام اب دستی ہے۔ بونس اسپن کے لیے @polnationsupport سے رابطہ کریں۔',
